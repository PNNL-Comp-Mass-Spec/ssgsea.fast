...
knitr::opts_chunk$set(echo = FALSE,
                      cache = FALSE,
                      warning = FALSE,
                      fig.height = 4.5, # < 225 mm (8.85 in), incl. legend
                      fig.width = 6.2, # < 170 mm (6.69 in)
                      fig.align = "center")
...
desktop_fast <- prepare_data("../data/ssGSEA-fast_timing_results_BLAS.rds")
