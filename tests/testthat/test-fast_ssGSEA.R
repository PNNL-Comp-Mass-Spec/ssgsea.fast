...
test_that("The columns of the results have the correct type and position", {
   ...
   expected_cols <- c("sample", "set", "set_size", "direction", "ES", "NES",
                      "n_same_sign", "n_as_extreme", "p_value", "adj_p_value")

   expect_identical(object = colnames(res),
                    expected = expected_cols)

   expected_col_types <- c("factor", "character", "integer", "factor",
...
test_that("the ES are correct for directional sets", {
   ...
   setcolorder(set1_res, neworder = "set", after = "sample")
