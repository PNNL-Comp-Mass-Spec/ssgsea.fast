...
.Rcpp_indexNumericVector <- function(x, idx) {
    .Call(`_ssgsea_fast_Rcpp_indexNumericVector`, x, idx)
}

.Rcpp_indexIntegerVector <- function(x, idx) {
    .Call(`_ssgsea_fast_Rcpp_indexIntegerVector`, x, idx)
}
...
.Rcpp_matmult_dense <- function(X, Y) {
    .Call(`_ssgsea_fast_Rcpp_matmult_dense`, X, Y)
}
...
.Rcpp_matmult_sparse <- function(X, Y) {
    .Call(`_ssgsea_fast_Rcpp_matmult_sparse`, X, Y)
}
...
.Rcpp_calcESCore <- function(alpha, min_size, Y, R, sumRanks, A, M, W) {
    .Call(`_ssgsea_fast_Rcpp_calcESCore`, alpha, min_size, Y, R, sumRanks, A, M, W)
}
...
.Rcpp_calcESPermCore <- function(alpha, Y_perm, R_perm, sumRanks_i, A_perm, theta_m_i, theta_w_i) {
    .Call(`_ssgsea_fast_Rcpp_calcESPermCore`, alpha, Y_perm, R_perm, sumRanks_i, A_perm, theta_m_i, theta_w_i)
}
...
.Rcpp_extractPermInfo <- function(x, y) {
    .Call(`_ssgsea_fast_Rcpp_extractPermInfo`, x, y)
}
